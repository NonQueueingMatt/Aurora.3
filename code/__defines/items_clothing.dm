...
#define IN_INVENTORY           0x40 // Used for examine tooltips.
#define IN_STORAGE             0x80 // Used for examine tooltips.
#define FORCE_STRING_OVERRIDE  0x100 //Used for examine tooltips.
