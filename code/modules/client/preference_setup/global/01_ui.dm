...
/datum/category_item/player_setup_item/player_global/ui/load_preferences(var/savefile/S)
	...
	S["darkmode_theme"]	>> pref.darkmode_theme
...
/datum/category_item/player_setup_item/player_global/ui/gather_save_parameters()
	return list(
		...
		"darkmode_theme" = pref.darkmode_theme,
...
/datum/category_item/player_setup_item/player_global/ui/sanitize_preferences()
	...
	if(pref.darkmode_theme != FALSE && pref.darkmode_theme != TRUE)
		pref.darkmode_theme = FALSE
...
/datum/category_item/player_setup_item/player_global/ui/content(mob/user)
	...
	dat += "<b>BYOND UI Style:</b> <a href='?src=\ref[src];select_theme_pref=1'><b>[pref.darkmode_theme ? "Dark Theme" : "Light Theme"]</b></a><br>"
...
/datum/category_item/player_setup_item/player_global/ui/OnTopic(var/href,var/list/href_list, var/mob/user)
	if(href_list["select_style"])
		...
		if(CanUseTopic(user))
			pref.darkmode_theme = !pref.darkmode_theme
