...
/datum/special_power/psionic/psychokinesis
	faculty = PSI_PSYCHOKINESIS
	use_manifest = TRUE
	use_sound = null

/datum/special_power/psionic/psychokinesis/psiblade
	name =            "Psiblade"
	cost =            10
	cooldown =        30
...
/datum/special_power/psionic/psychokinesis/psiblade/invoke(var/mob/living/user, var/mob/living/target)
...
/datum/special_power/psionic/psychokinesis/tinker
	name =            "Tinker"
	cost =            5
	cooldown =        10
...
/datum/special_power/psionic/psychokinesis/tinker/invoke(var/mob/living/user, var/mob/living/target)
...
/datum/special_power/psionic/psychokinesis/telekinesis
	name =            "Telekinesis"
	cost =            5
	cooldown =        10
	use_ranged =      TRUE
...
/datum/special_power/psionic/psychokinesis/telekinesis/invoke(var/mob/living/user, var/mob/living/target)
