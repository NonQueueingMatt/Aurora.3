...
/obj/machinery/door/handle_vehicle_bump(obj/vehicle/multitile/V)
...
/obj/machinery/door/poddoor/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(!(V.vehicle_flags & VEHICLE_CLASS_WEAK))
		if(!unacidable)
			visible_message(SPAN_DANGER("\The [V] pushes [src] over!"))
			playsound(V, 'sound/effects/metal_crash.ogg', 35)
...
/obj/machinery/door/poddoor/shutters/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(!unacidable)
		visible_message(SPAN_DANGER("\The [V] pushes [src] over!"))
		playsound(V, 'sound/effects/metal_crash.ogg', 35)
		qdel(src)
...
/obj/machinery/door/poddoor/almayer/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(!unacidable)
...
/obj/machinery/cm_vending/handle_vehicle_bump(obj/vehicle/multitile/V)
	visible_message(SPAN_DANGER("\The [V] pushes [src] over!"))
	playsound(V, 'sound/effects/metal_crash.ogg', 20)
	tip_over()
	return TRUE

/obj/machinery/m56d_post/handle_vehicle_bump(obj/vehicle/multitile/V)
...
/obj/machinery/m56d_hmg/handle_vehicle_bump(obj/vehicle/multitile/V)
...
/obj/machinery/m56d_hmg/mg_turret/handle_vehicle_bump(obj/vehicle/multitile/V)
	playsound(V, 'sound/effects/metal_crash.ogg', 20)
	visible_message(SPAN_DANGER("\The [V] drives over \the [src]!"))
	update_health(health + 1)
	return TRUE

/obj/machinery/m56d_hmg/auto/handle_vehicle_bump(obj/vehicle/multitile/V)
...
/obj/machinery/defenses/sentry/handle_vehicle_bump(obj/vehicle/multitile/V)
	visible_message(SPAN_DANGER("\The [V] drives over \the [src]!"))
	playsound(V, 'sound/effects/metal_crash.ogg', 20)
	if(static)
		update_health(health + 1)
...
/obj/machinery/defenses/sentry/premade/dropship/handle_vehicle_bump(obj/vehicle/multitile/V)
	deployment_system.undeploy_sentry()
	return FALSE

/obj/machinery/m56d_hmg/mg_turret/dropship/handle_vehicle_bump(obj/vehicle/multitile/V)
	deployment_system.undeploy_mg()
	return FALSE

/obj/machinery/defenses/sentry/launchable/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(V.seats[VEHICLE_DRIVER])
		var/last_moved = V.l_move_time //in case VC moves before answering
		if(alert(V.seats[VEHICLE_DRIVER], "Are you sure you want to crush \the [name]?", "Ramming confirmation","Yes","No") == "Yes")
			if(last_moved == V.l_move_time)
...
/obj/machinery/disposal/handle_vehicle_bump(obj/vehicle/multitile/V)
	qdel(src)
	return TRUE

/obj/machinery/hydro_floodlight/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(V.vehicle_flags & VEHICLE_CLASS_WEAK)
		return FALSE
	playsound(V, 'sound/effects/metal_crash.ogg', 20)
	visible_message(SPAN_DANGER("\The [V] crushes \the [src]!"))
...
/obj/machinery/floodlight/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(V.vehicle_flags & VEHICLE_CLASS_WEAK)
		return FALSE
	playsound(V, 'sound/effects/metal_crash.ogg', 20)
	visible_message(SPAN_DANGER("\The [V]crushes \the [src]!"))
...
/obj/machinery/colony_floodlight/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(V.vehicle_flags & VEHICLE_CLASS_WEAK)
		return FALSE
...
/obj/machinery/floodlight/landing/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(V.vehicle_flags & VEHICLE_CLASS_HEAVY)
		playsound(V, 'sound/effects/metal_crash.ogg', 20)
		visible_message(SPAN_DANGER("\The [V] crushes \the [src]!"))
		qdel(src)
...
/obj/machinery/autolathe/handle_vehicle_bump(obj/vehicle/multitile/V)
...
/obj/machinery/portable_atmospherics/hydroponics/handle_vehicle_bump(obj/vehicle/multitile/V)
	if(!(V.vehicle_flags & VEHICLE_CLASS_WEAK))
		playsound(V, 'sound/effects/metal_crash.ogg', 20)
		visible_message(SPAN_DANGER("\The [V] crushes \the [src]!"))
		qdel(src)
